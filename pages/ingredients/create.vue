<template>
      <form class="container mt-8 mb-2 min-w-xs md:min-w-[672px] lg:min-w-[896px]">
            <div class="mb-10 pb-10 border-b-2 border-red-300 grid md:grid-cols-2 gap-6">
                  <CustomInput content="Nome" />

                  <CustomInput content="Marchio" />
            ...
            <div class="mb-4 grid md:grid-cols-4 gap-6">
                  <CustomInput content="Calorie" />

                  <CustomInput content="Grassi" />

                  <CustomInput content="Grassi saturi" />

                  <CustomInput content="Proteine" />

                  <CustomInput content="Carboidrati" />

                  <CustomInput content="Zuccheri" />

                  <CustomInput content="Fibre" />
            </div>
      </form>
</template>
